...
- Global constitution and workflow templates: `scripts/lib/installer.mjs` (`CONSTITUTION_TEMPLATE`, `WORKFLOW_TEMPLATE`). These are the source of truth — `/crew:install` writes them to `~/.claude/engineering-os/`.
